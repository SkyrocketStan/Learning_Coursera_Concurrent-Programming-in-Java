...
/**
 * An actor-based implementation of the Sieve of Eratosthenes. countPrimes to determine the number
 * of primes <= limit.
 */
public final class SieveActor extends Sieve {
   ...
   * {@inheritDoc}
   *
   * <p>limit in parallel. You might consider how you can model the Sieve of Eratosthenes as a
   * pipeline of actors, each corresponding to a single prime number.
   */
  @Override
